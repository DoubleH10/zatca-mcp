...
from zatca_mcp.utils.signing import (  # noqa: E402
    canonicalize_xml,
    generate_csr,
...
from zatca_mcp.utils.xml_builder import build_invoice_xml  # noqa: E402
...
class TestKeyGeneration:
    ...
    def test_serialize_deserialize_roundtrip(self):
        ...
        assert key.public_key().public_numbers() == loaded.public_key().public_numbers()
...
class TestCSRGeneration:
    ...
    def test_csr_subject_fields(self):
        ...
        ou_val = subject.get_attributes_for_oid(NameOID.ORGANIZATIONAL_UNIT_NAME)[0].value
        assert ou_val == "Invoicing"
        cn_val = subject.get_attributes_for_oid(NameOID.COUNTRY_NAME)[0].value
        assert cn_val == "SA"
        sn_val = subject.get_attributes_for_oid(NameOID.SERIAL_NUMBER)[0].value
        assert sn_val == "1-TST|2-TST|3-test-uuid"
...
class TestCanonicalization:
    ...
    def test_strips_ubl_extensions(self):
        ...
        xml_with_ext = xml.replace(
            "<cbc:ProfileID",
            f'<ext:UBLExtensions xmlns:ext="{ext_ns}">'
            "<ext:UBLExtension><ext:ExtensionContent>"
            "dummy</ext:ExtensionContent></ext:UBLExtension>"
...
class TestSigning:
    ...
    def test_hash_matches_tlv_tag6(self):
        ...
        inject_signature(xml.encode("utf-8"), cert_pem, key)
